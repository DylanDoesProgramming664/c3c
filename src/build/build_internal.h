...
#define DEFAULT_TARGET WINDOWS_X64
#elif defined(__amd64__) || defined(__amd64) || defined(__x86_64__) || defined(__x86_64)
	#if defined(__MACH__)
#define DEFAULT_TARGET MACOS_X64
	#elif defined(__ANDROID__)
#define DEFAULT_TARGET ANDROID_X86_64
	#elif defined(__linux__) && __linux__
#define DEFAULT_TARGET LINUX_X64
		#if (defined(__GLIBC__) && __GLIBC__) || (defined(__GLIBC_MINOR__) && __GLIBC_MINOR__)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_GNU
		#elif defined(__DEFINED_va_list)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_MUSL
		#endif
	#elif defined(__NetBSD__)
#define DEFAULT_TARGET NETBSD_X64
	#elif defined(__FreeBSD__)
#define DEFAULT_TARGET FREEBSD_X64
	#elif defined(__OpenBSD__)
#define DEFAULT_TARGET OPENBSD_X64
	#else
#define DEFAULT_TARGET ELF_X64
	#endif
#elif defined(__aarch64__) || defined(_M_ARM64)
	#if defined(__MACH__)
#define DEFAULT_TARGET MACOS_AARCH64
	#elif defined(__ANDROID__)
#define DEFAULT_TARGET ANDROID_AARCH64
	#elif defined(__linux__) && __linux__
#define DEFAULT_TARGET LINUX_AARCH64
		#if (defined(__GLIBC__) && __GLIBC__) || (defined(__GLIBC_MINOR__) && __GLIBC_MINOR__)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_GNU
		#elif defined(__DEFINED_va_list)
...
#define DEFAULT_LIBC LINUX_LIBC_MUSL
		#endif
	#else
#define DEFAULT_TARGET ELF_AARCH64
	#endif
#elif defined(i386) || defined(__i386__) || defined(__i386) || defined(_M_IX86)
	#if defined(__linux__) && __linux__
#define DEFAULT_TARGET LINUX_X86
		#if (defined(__GLIBC__) && __GLIBC__) || (defined(__GLIBC_MINOR__) && __GLIBC_MINOR__)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_GNU
		#elif defined(__DEFINED_va_list)
...
#define DEFAULT_LIBC LINUX_LIBC_MUSL
		#endif
	#elif defined(__FreeBSD__)
#define DEFAULT_TARGET FREEBSD_X86
	#elif defined(__OpenBSD__)
#define DEFAULT_TARGET OPENBSD_X86
	#elif defined(__NetBSD__)
#define DEFAULT_TARGET NETBSD_X86
	#elif defined(_MSC_VER) && _MSC_VER
#define DEFAULT_TARGET WINDOWS_X86
	#else
#define DEFAULT_TARGET ELF_X86
	#endif
#elif defined(__riscv32)
	#if defined(__linux__) && __linux__
#define DEFAULT_TARGET LINUX_RISCV32
		#if (defined(__GLIBC__) && __GLIBC__) || (defined(__GLIBC_MINOR__) && __GLIBC_MINOR__)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_GNU
		#elif defined(__DEFINED_va_list)
...
#define DEFAULT_LIBC LINUX_LIBC_MUSL
		#endif
	#else
#define DEFAULT_TARGET ELF_RISCV32
	#endif
#elif defined(__riscv64)
	#if defined(__linux__) && __linux__
#define DEFAULT_TARGET LINUX_RISCV64
		#if (defined(__GLIBC__) && __GLIBC__) || (defined(__GLIBC_MINOR__) && __GLIBC_MINOR__)
#define LINUX_LIBC
#define DEFAULT_LIBC LINUX_LIBC_GNU
		#elif defined(__DEFINED_va_list)
...
#define DEFAULT_LIBC LINUX_LIBC_MUSL
		#endif
	#else
#define DEFAULT_TARGET ELF_RISCV64
	#endif
#else
#define DEFAULT_TARGET ARCH_OS_TARGET_DEFAULT
#endif
